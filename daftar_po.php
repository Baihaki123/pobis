...
<head>
    ...
    <link rel="stylesheet" href="bootsrap/css/bootstrap.min.css.map">
...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link px-md-4" href="data_penumpang.php">Data Penumpang</a>
                        </li>
                        <li class="nav-item">
    ...
    <div class="container">
        <div class="card">
            <h2 style="text-align: center;">Dedi Jaya</h2><br>
            <div class="row">
                <div class="col-md-4"><img src="gambar/dedi.jpg" style="width: 300px;"></div>
                <div class="col-md-4"><img src="gambar/dedi.jpg" style="width: 300px;"></div>
                <div class="col-md-4"><img src="gambar/dedi.jpg" style="width: 300px;"></div>
            </div>
            <br>
            <h2 style="text-align: center;">Dewi Sri</h2><br>
            <div class="row">
                <div class="col-md-4"><img src="gambar/dewi sri.jpg" style="width: 300px;"></div>
                <div class="col-md-4"><img src="gambar/dewi sri.jpg" style="width: 300px;"></div>
                <div class="col-md-4"><img src="gambar/dewi sri.jpg" style="width: 300px;"></div>
            </div>
            <br>
            <table class="table table-bordered">
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="text-align: center;">DediJaya</td>
                        <td style="text-align: center;">Rp. 250.000</td>

                    </tr>
                    <tr>
                        <td style="text-align: center;">2</td>
                        <td style="text-align: center;">Dewi Sri</td>
