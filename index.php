  ...
  <section class="h-100 w-100" style="box-sizing: border-box; background-color: #141432">
    ...
    <div class="header-4-3 container-xxl mx-auto p-0 position-relative" style="font-family: 'Poppins', sans-serif;">
      <nav class="navbar navbar-expand-lg navbar-dark">
        <a href="#">
          <img style="margin-right:0.75rem" src="http://api.elements.buildwithangga.com/storage/files/2/assets/Header/Header2/Header-2-3.png" alt="">
        </a>
            ...
            <div class="modal-content border-0" style="background-color: #141432;">
              ...
              <div class="modal-body" style="padding:	2rem; padding-top: 0; padding-bottom: 0;">
                <ul class="navbar-nav responsive me-auto mt-2 mt-lg-0">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="#">Data PO</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="#">Data Penumpang</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="#">Data BUS</a>
                  </li>
                  <li class="nav-item">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo">
          <ul class="navbar-nav me-auto mt-2 mt-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link" href="daftar_po.php">Data PO</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="data_penumpang.php">Data Penumpang</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#">Data BUS</a>
            </li>
      ...
      <div>
        <div class="mx-auto d-flex flex-lg-row flex-column hero">
          ...
          <div class="left-column d-flex flex-lg-grow-1 flex-column align-items-lg-start text-lg-start align-items-center text-center">
            ...
            <h1 class="title-text-big">Pesan Tiket Online Tidak Perlu Ribet<br class=" d-lg-block d-none">Tinggal Klik Lebih Asyik</h1>
            <div class="d-flex flex-sm-row flex-column align-items-center mx-lg-0 mx-auto justify-content-center gap-3">
              <button class="btn d-inline-flex mb-md-0 btn-try text-white border-0">Skuy</button>
          ...
          <div class="right-column text-center d-flex justify-content-lg-end justify-content-center pe-0">
            <img id="img-fluid" class="h-auto mw-100" src="http://api.elements.buildwithangga.com/storage/files/2/assets/Header/Header4/Header-4-3.png" alt="">
          </div>
      ...
      <div class="grid-padding text-center">
        <div class="row">
          <div class="col-lg-4 column">
            ...
            <h3 class="icon-title text-white">Mudah dan cepat</h3>
            <p class="icon-caption">
              Tidak perlu <br />
              ke terminal untuk pesan
            </p>
          </div>
          <div class="col-lg-4 column">
            <div class="icon">
            ...
            <h3 class="icon-title text-white">Murah</h3>
            <p class="icon-caption">
              Harga terjangkau<br />
            </p>
          </div>
          <div class="col-lg-4 column">
            ...
            <h3 class="icon-title text-white">Pelayanan Terbaik</h3>
            <p class="icon-caption">
              Anda cukup dirumah<br />
              Kami yang proses
            </p>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-md-6 mt-md-0 mt-3 address">
          ...
          <div class="social-media">
            <a href="#">
              <img src="https://api.elements.buildwithangga.com/storage/files/2/assets/Content/Content10/bi_linkedin.svg" alt="linkedin" class="img-fluid mr-4">
            </a>
            <a href="#">
              <img src="https://api.elements.buildwithangga.com/storage/files/2/assets/Content/Content10/bi_facebook.svg" alt="facebook" class="img-fluid mr-4">
            </a>
            <a href="#">
              <img src="https://api.elements.buildwithangga.com/storage/files/2/assets/Content/Content10/bi_twitter.svg" alt="twitter" class="img-fluid mr-4">
            </a>
            <a href="#">
              <img src="https://api.elements.buildwithangga.com/storage/files/2/assets/Content/Content10/bi_instagram.svg" alt="twitch" class="img-fluid mr-4">
            </a>
          </div>
